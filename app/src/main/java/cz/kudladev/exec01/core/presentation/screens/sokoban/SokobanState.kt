...
data class SokobanState(
    val selectedLevel: Level = Level(0, level1, level1, 10, 10,10, 0,0, false,false),
    val levels: List<Level> = emptyList(),
    val editorLevel: MutableState<Level> = mutableStateOf(Level(0, level1, level1, 10, 10,10, 0,0, false,false)),
)
